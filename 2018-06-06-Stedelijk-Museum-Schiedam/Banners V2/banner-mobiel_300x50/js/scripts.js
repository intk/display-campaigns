...
$(document).ready(function() {	
	function animateAd(count) {
		...
		self.setTimeout(function(){
			$('div.wrapper figure.diederix figcaption span.title').addClass('show');
		}, 5000);

		self.setTimeout(function(){
			$('div.wrapper figure.diederix figcaption span.pretitle').addClass('show');
		}, 5500);

		self.setTimeout(function(){
			$('div.wrapper figure.diederix figcaption span.date').addClass('show');
		}, 5500);

		self.setTimeout(function(){
			$('div.wrapper figure.diederix figcaption span').removeClass('show');
		}, 9000);
		...
		if (count < 1) {
			...
			self.setTimeout(function(){
				$('div.wrapper figure.tytgat').removeClass('last');
			}, 15000);
